...
const ChatDetail = ({ notifications = 0, image, title, subTitle, time }) => {
  ...
  return (
    <div
      ...
      className="flex flex-row justify-between items-center w-full cursor-pointer hover:bg-backgroundNav px-3 py-1 customBottomBorder"
    >
      <Avatar size={12} image={image} title={title} subtitle={trimedTitle} />
